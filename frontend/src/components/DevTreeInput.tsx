        ...
        <div className="bg-white shadow-sm p-5 flex items-center gap-3">
            ...
            <Switch
                ...
                className={classNames(
                    ...
                    'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-transparent transition-colors duration-200 ease-in-out focus:outline-none'
                )}
            >
                <span
                    aria-hidden="true"
